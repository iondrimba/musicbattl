...
{
    public class ViewPastBattlsQueryParams : IViewPastBattlsQueryParams , IDataQuery
    {
        #region IViewPastBattlsQueryParams Members
        ...
        private string _secondAlbumId;

        public string SecondAlbumId
        {
        ...
        #endregion IViewPastBattlsQueryParams Members
